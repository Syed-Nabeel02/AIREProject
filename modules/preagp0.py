...
def generate_output_folder() -> None:
    output_folder_path = Path(__file__).parent.parent / "output" / "pre_agp0_output"
    output_folder_path.mkdir(exist_ok=True)

def generate_template() -> DocxTemplate:
    template_path = Path(__file__).parent.parent / "resources" / "pre_agp0" / "Architecture Intake Review Engine Report Draft.docx"
...
def get_rubric_descriptions() -> list:
    ...
    template_path = Path(__file__).parent.parent / "resources" / "pre_agp0" / "IIT-EA-Decision-Matrix.xlsx"
...
def save_output_template(doc: DocxTemplate) -> None:
    output_file_path = Path(__file__).parent.parent / "output" / "pre_agp0_output" / "pre_agp0_assessment_report.docx"
...
if __name__ == '__main__':
    base_dir = Path(__file__).parent.parent / "resources" / "pre_agp0"
    print(base_dir)