...
def generate_agp_0_report(agp0_submission_path) -> None:
    ...
    agp0_extracted_path = Path(__file__).parent.parent.parent / "output" / "agp0_output" 
    shutil.rmtree(agp0_extracted_path)

def extract_zip_file(agp0_submission_path: str) -> None:
    directory_to_extract_to = Path(__file__).parent.parent.parent / "output" / "agp0_output" 
